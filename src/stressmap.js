const map = L.map('mapid').setView([10.01643, -84.21306], 17)
const settings = [{ color: '#0099cc', weight: 3, key: 'LTS1', zIndex: 1, title: 'LTS 1 - M&iacute;nimo riesgo', url: 'data/level_1.json' },
                { color: '#1C7C54', weight: 3, key: 'LTS2', zIndex: 2, title: 'LTS 2 - Riesgo bajo', url: 'data/level_2.json' },
                { color: '#F0C808', weight: 3, key: 'LTS3', zIndex: 3, title: 'LTS 3 - Riesgo moderado', url: 'data/level_3.json' },
                { color: '#DD5454', weight: 3, key: 'LTS4', zIndex: 4, title: 'LTS 4 - Riesgo alto', url: 'data/level_4.json' }]
const homePage = '#'
const legendTitle = 'Mapa de Riesgo para Movilidad Ciclista'
const layers = {}
